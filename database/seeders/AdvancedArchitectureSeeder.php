    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'related_products' => 'stevia-powder-1-10-100g,stevia-powder-1-50-50g,stevia-drops-1-10-50g',
            ],
            [
                ...
                'sweetness_description' => '1g replaces 10g of sugar',
                'use_case' => 'tea, coffee, smoothies',
                'related_products' => 'stevia-powder-1-10-50g,stevia-powder-1-50-100g,stevia-drops-1-10-100g',
            ],
            // Stevia Powder 1:50
            [
                ...
                'use_case' => 'baking, cooking',
                'related_products' => 'stevia-powder-1-50-100g,stevia-powder-1-10-50g,stevia-drops-1-10-50g',
            ],
            [
                ...
                'sweetness_description' => '1g replaces 50g of sugar',
                'use_case' => 'baking, cooking',
                'related_products' => 'stevia-powder-1-50-50g,stevia-powder-1-10-100g,stevia-drops-1-10-100g',
            ],
            // Stevia Drops 1:10
            [
                ...
                'sweetness_description' => '1g replaces 10g of sugar',
                'use_case' => 'tea, coffee, smoothies',
                'related_products' => 'stevia-drops-1-10-100g,stevia-powder-1-10-50g,monk-fruit-powder-1-10-50g',
            ],
            [
                'name' => 'Stevia Drops 1:10 100g',
                'slug' => 'stevia-drops-1-10-100g',
                'category_id' => $sd10->id,
                'type' => 'stevia',
                'form' => 'drops',
                'ratio' => '1:10',
                ...
                'sweetness_description' => '1g replaces 10g of sugar',
                'use_case' => 'tea, coffee, smoothies',
                'related_products' => 'stevia-drops-1-10-50g,stevia-powder-1-10-100g,monk-fruit-powder-1-10-100g',
            ],
            ...
            [
                ...
                'sweetness_description' => '1g replaces 10g of sugar',
                'use_case' => 'tea, coffee, smoothies',
                'related_products' => 'monk-fruit-powder-1-10-100g,stevia-powder-1-10-50g,stevia-drops-1-10-50g',
            ],
            [
                'name' => 'Monk Fruit Powder 1:10 100g',
                'slug' => 'monk-fruit-powder-1-10-100g',
                'category_id' => $mp10->id,
                'type' => 'monk-fruit',
                'form' => 'powder',
                'ratio' => '1:10',
                ...
                'sweetness_description' => '1g replaces 10g of sugar',
                'use_case' => 'tea, coffee, smoothies',
                'related_products' => 'monk-fruit-powder-1-10-50g,stevia-powder-1-10-100g,stevia-drops-1-10-100g',
            ],
        ];
